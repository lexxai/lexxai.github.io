...
Продовжуючи експерименти з [OpenWrt Attitude](https://lexxai.github.io/2012/08/tp-link-wr1043n-openwrt-attitude.html) додав можливості використовувати Router TP-Link 1043, як Інтренет радіо тюнер.  
