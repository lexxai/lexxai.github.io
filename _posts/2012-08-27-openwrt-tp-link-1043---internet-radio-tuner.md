...
Продовжуючи експерименти з [OpenWrt Attitude](/2012-08-19-tp-link-wr1043n-openwrt-attitude-adjustment.md) додав можливості використовувати Router TP-Link 1043, як Інтренет радіо тюнер.  
