---
layout: post
title: "Закінчення курсу Python Web. 14 моїх домашніх завдань."
date: 2023-12-03 10:35:00 +0000
tags: ["education", "GoIT", "python"]
blogger_orig_link: https://lexxai.blogspot.com/2023/12/python-web-14.html
---
...
[![](/assets/images/blog/6247803b2b2947e3-b9eb50fee1f3174f.jpg)](https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEg4ottPdmWR9dMgFVP6JH4PWIeSj6SJoDpCPO57eXDjea-duVqmO4_1DmPLTwf1d1zAURaSeCdE2KL2KBnD42owoah7x2R2G-rbWxyAPCEh3AfUPOiu04wVBG-tW65cUSvr_G7EAMubt_epeA5tprHOCqntuRX7UgivtraVstN2OG_ncva4ksehGL5JX9Ni/s1024/A%20programmer%20with%20Python%20with%20a%20long%20beard,%2050%20years%20old,%20in%20Ukraine%20where%20there%20is%20a%20war.jpg)
...
10. * (Homework) <https://github.com/lexxai/goit_python_web_hw_10>
...
11. * (Homework) <https://github.com/lexxai/goit_python_web_hw_11>

      GoIT, Python WEB, Homework number 11. FastAPI. PostgreSQL.
      Docker. REST API. ORM SQLAlchemy. Pydantic. Bootstraps CSS. Jinga.
      Alembic.
    ...
    * (prepend) [FastAPI (Part1)](https://github.com/lexxai/goit_python_web_fastapi_lect_01/tree/lection_02_repo)
      ...
      GoIT, Python WEB, Prepend Homework number 11. FastAPI.
      Lection Cats. PostgreSQL. Docker. Bootstraps CSS. ORM SQLAlchemy.
      Pydantic

      #FastAPI. #PostgreSQL. #Docker. #python, #SQLAlchemy #Pydantic
12. * (Homework) <https://github.com/lexxai/goit_python_web_hw_12>

      GoIT, Python WEB, Homework number 12. FastAPI. PostgreSQL.
      Docker. REST API. ORM SQLAlchemy. Pydantic. Bootstraps CSS. Jinga.
      Alembic. OAuth2. JWT.
    ...
    * (prepend) [FastAPI (Part2. Auth. JS Front-end)](https://github.com/lexxai/goit_python_web_fastapi_lect_01/tree/lect-02-client)
      ...
      GoIT, Python WEB, Prepend Homework number 12. FastAPI.
      Lection Cats. PostgreSQL. Docker. Bootstraps CSS. ORM SQLAlchemy.
      Pydantic
...
13. * (Homework)
      ...
      GoIT, Python WEB, Homework number 12. FastAPI. PostgreSQL.
      Docker. REST API. ORM SQLAlchemy. Pydantic. Bootstraps CSS. Jinga.
      Alembic. OAuth2. JWT. Redis. Cloudinary. Limits

      #FastAPI. #PostgreSQL. #Docker. #Javascript. #Bootstraps #python #SQLAlchemy #Pydantic #Jinga2 #Alembic. #OAuth2. #JWT.
    * (prepend) [FastAPI (Part3. Security. Cloudinary)](https://github.com/lexxai/goit_python_web_fastapi_lect_01/tree/cloudinary)
    * (prepend) [Django reset\_password](https://github.com/lexxai/goit_python_web_django_lect_02_notes/tree/reset_password)
...
Наділі має бути курсова робота, якщо виживемо ...
