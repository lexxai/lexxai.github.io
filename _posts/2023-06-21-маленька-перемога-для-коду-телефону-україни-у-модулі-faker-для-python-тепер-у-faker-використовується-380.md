...
tags: ["+380", "faker", "localization", "python", "Україна"]
blogger_orig_link: https://lexxai.blogspot.com/2023/06/faker-python-faker-380.html
---

Знайдено було невідповідність у модулі [Faker](https://github.com/joke2k/faker) для Python запису [телефонного коду України +380](/2017-08-19-україна-починається-з-малого-телефонний-код-країни-380-а-не-38.md).
